...
$("#calcdivideandconquerV2").click(function(event){
  event.preventDefault();
//this will find the selected website from the dropdown
var str_A = $("#str_A").val();
var str_B = $("#str_B").val();
...
if(str_A == '' || str_B == ''){
 ...
 // alert("ffff");
  ...
  var url1 = "/divideandconquer2/"+str_A+"/"+str_B;
  //console.log(url1);
//this will redirect us in same window
 window.location = url1;
});

$("#calcdivideandconquerV2Reset").click(function(event){
  event.preventDefault();
//this will find the selected website from the dropdown
  var url2 = "/divideandconquer2";
  //console.log(url1);
//this will redirect us in same window
 window.location = url2;
});
